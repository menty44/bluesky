...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Smart Shopper | Groups</title>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#PersonTableContainer').jtable({
            ...
            actions: {
                listAction: 'ArticleCRUDController?action=list',
                createAction:'ArticleCRUDController?action=create',
                updateAction: 'ArticleCRUDController?action=update',
                deleteAction: 'ArticleCRUDController?action=delete'
            },
            fields: {
            	article_id: {
                	title:'Serial.NO',
